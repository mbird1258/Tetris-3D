...
namespace UnityEngine.XR.ARFoundation
{
    ...
    public class ARPlaneDebugVisualizer : MonoBehaviour
    {
        ...
        bool m_ShowClassification = false;

        [SerializeField]
        [Tooltip("Show alignment visualizer.")]
        bool m_ShowAlignment = false;

        [SerializeField]
        [Tooltip("Show tracking state visualizer.")]
        bool m_ShowTrackingState = false;
        ...
        Color trackingColor = new Color(253, 184, 19, 16);
        ...
        void Update()
        {
            ...
            Color trackingColor = new Color(253F/255, 184F/255, 19F/255, 32F/255);
